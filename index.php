...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('images/mbs.jpg'); /* Sesuaikan dengan lokasi gambar Anda */
...
<body class="bg-gray-100">
    ...
    <header class="flex items-center justify-start p-4 bg-black bg-opacity-50">
        <img src="images/logo.png" alt="Logo" class="h-20 w-20 mr-4"> <!-- Sesuaikan ukuran logo di sini -->
